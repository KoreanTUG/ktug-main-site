...
> **참고** 이 안내서 작성자의 개인적인 취향 때문에 처음에는 외장 뷰어를 설치하고 설정하는 내용을 포함하고 있었습니다. 그러나 그 과정이 너무 번거로워서 처음 사용자를 당황하게 만든다는 지적이 있어서 이를 부록으로 돌렸습니다. 관심있는 분은 [부록](/tutorials/tex/windows/texlive/utils/)의 SumatraPDF 관련 내용을 참고하기 바랍니다.

## 다음 단계

Visual Studio Code 설정이 완료되었습니다. 이제 [lshort-ko 학습하기](/tutorials/tex/windows/texlive/lshort/)로 진행하세요.
