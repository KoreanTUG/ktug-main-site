...
![VS Code 설치](/assets/images/windows/texlive/vscode-inst.png)

그러면 VS Code의 설치가 시작됩니다.

![VS Code 설치 진행](/assets/images/windows/texlive/vscode-inst-gui.png)

설치가 완료된 후에 `Windows`를 눌러서 `code`라고 입력하여 이 앱을 잘 실행할 수 있는지 확인합니다.

![VS Code 실행](/assets/images/windows/texlive/win-menu-vscode.png)
...
![VS Code 첫 실행](/assets/images/windows/texlive/vscode-init.png)
...
![새 폴더 만들기](/assets/images/windows/texlive/expl-new-dir.png)
...
![폴더 열기](/assets/images/windows/texlive/vscode-open-folder.png)
...
![신뢰할 수 있는 작업 공간](/assets/images/windows/texlive/vscode-trust-folder.png)
...
![사용자 설정](/assets/images/windows/texlive/vscode-pref.png)

설정에서는 폰트 크기와 폰트 종류 정도를 지정해봅니다. 다음 그림은 현재 필자의 설정입니다.

![폰트 설정](/assets/images/windows/texlive/vscode-gen-settings.png)
...
![LaTeX Workshop 메뉴](/assets/images/windows/texlive/vscode-latexworkshop.png)
...
![settings.json](/assets/images/windows/texlive/vscode-user-settings-json.png)

이제 `Ctrl+Alt+B`를 눌러서 현재 편집 중인 파일을 컴파일해봅니다. 컴파일 과정을 보려면 `Ctrl+Shift+U`를 누른 다음 "작업"을 "LaTeX Compiler"로 하면 됩니다.

![컴파일 진행](/assets/images/windows/texlive/vscode-compiler.png)
