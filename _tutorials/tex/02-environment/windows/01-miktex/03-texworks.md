...
![TeXworks 환경 설정 열기](/assets/images/windows/miktex/cap014.png)
...
![편집기 설정](/assets/images/windows/miktex/cap015.png)

### 문서처리 탭

다른 것은 건드리지 말고 "기본값"을 `XeLaTeX`으로 선택합니다.

![문서처리 설정](/assets/images/windows/miktex/cap016.png)

여기서 **확인** 버튼을 누르고 TeXworks 실행을 종료한 다음 다시 실행합니다.

## 다음 단계

TeXworks 설정이 완료되었습니다. 이제 [첫 문서 작성하기](/tutorials/tex/windows/miktex/first-doc/)로 진행하세요.
