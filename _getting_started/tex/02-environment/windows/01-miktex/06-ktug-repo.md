...
permalink: /getting-started/windows/miktex/ktug-repo/
prev_tutorial: /getting-started/windows/miktex/fonts/
next_tutorial: /getting-started/windows/miktex/vscode/
---
...
KTUG 사설저장소 패키지 설정이 완료되었습니다. 이제 <a href="{{ '/getting-started/windows/miktex/vscode/' | relative_url }}">Visual Studio Code 사용하기</a>로 진행하세요.
