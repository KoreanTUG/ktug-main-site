...
permalink: /getting-started/before-you-start/
next_tutorial: /getting-started/environment/
---
...
- <a href="{{ '/getting-started/environment/' | relative_url }}">TeX 작업 환경 구축</a>: 운영체제별 TeX 작업 환경 구축 절차와 방법을 안내합니다.
