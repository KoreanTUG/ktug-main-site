...
permalink: /getting-started/windows-miktex/fonts/
prev_tutorial: /getting-started/windows-miktex/first-doc/
next_tutorial: /getting-started/windows-miktex/ktug-repo/
---
...
폰트 설치가 완료되었습니다. 이제 <a href="{{ '/getting-started/windows-miktex/ktug-repo/' | relative_url }}">KTUG 사설저장소 패키지</a>로 진행하세요.
