...
permalink: /getting-started/windows-miktex/install/
prev_tutorial: /getting-started/windows-miktex/prep/
next_tutorial: /getting-started/windows-miktex/texworks/
---
...
MiKTeX 설치가 완료되었습니다. 이제 <a href="{{ '/getting-started/windows-miktex/texworks/' | relative_url }}">TeXworks 설정</a>으로 진행하세요.
