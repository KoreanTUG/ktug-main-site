...
<img src="{{ '/assets/images/macos-mactex/win-menu-term.png' | relative_url }}" alt="Windows 메뉴에서 터미널 검색">
...
준비가 완료되었습니다. 이제 <a href="{{ '/getting-started/macos-mactex/install/' | relative_url }}">TeX Live 설치</a>로 진행하세요.
