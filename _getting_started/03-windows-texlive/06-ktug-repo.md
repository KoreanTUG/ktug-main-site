...
<img src="{{ '/assets/images/macos-mactex/win-term-run.png' | relative_url }}" alt="터미널 실행">
...
<img src="{{ '/assets/images/macos-mactex/ktug-repo-add.png' | relative_url }}" alt="KTUG 사설저장소 설정">
...
<img src="{{ '/assets/images/macos-mactex/tlshell-ktug-repo.png' | relative_url }}" alt="TLShell 화면">
...
<img src="{{ '/assets/images/macos-mactex/tlshell-not-installed.png' | relative_url }}" alt="TLShell 패키지 목록 갱신">
...
<img src="{{ '/assets/images/macos-mactex/tlshell-pkg-search.png' | relative_url }}" alt="TLShell 패키지 탐색">

탐색 결과로 표시된 패키지를 선택(mark)하고 **Install marked**를 누릅니다. 그러면 다음과 같이 jiwonlipsum 패키지가 설치됩니다. 

<img src="{{ '/assets/images/macos-mactex/tlshell-pkg-inst.png' | relative_url }}" alt="TLShell 패키지 탐색">
